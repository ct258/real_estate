...
Route::group(['middleware' => 'web'], function () {
    // Route::get('/login', 'TaiKhoanController@getLogin')->name('getLogin');
    // Route::get('/', function () {
    //     return view('auth.login');
    // })->name('getLogin');
    Route::get('/', array('as' => 'getLogin', function () {
        return view('auth.login');
    }));
    // Route::post('/login', ['as' => 'getLogin', 'uses' => 'TaiKhoanController@getLogin']);
    Route::post('/dangnhap', ['as' => 'postLogin', 'uses' => 'TaiKhoanController@postLogin']);
    Route::get('/logout', 'Master\TaiKhoanController@logout')->name('logout');
