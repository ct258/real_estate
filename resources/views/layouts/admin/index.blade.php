                ...
                <div class="col-lg-4">
                    <section class="widget large">
                        <header>
                            ...
                            <div class="actions">
                                <button class="btn btn-transparent btn-xs">Show All <i
                            ...
                            <div id="feed" class="feed">
                                <div class="wrapper">
                                    ...
                                    <section class="feed-item">
                                        ...
                                        <div class="feed-item-body">
                                            <div class="text">
                                                <a href="#">Merge request #42</a> has been approved by <a
                                                    href="#">Jessica Lori</a>.
                                            </div>
                                            <div class="time pull-left">
                                                10 h
                    ...
                    <section class="widget widget-tabs">
                        ...
                        <div class="body tab-content">
                            <div id="stats" class="tab-pane active clearfix">
                                <h5 class="tab-header"><span class="label label-primary"><i
                                            class="fa fa-facebook"></i></span> Last logged-in users</h5>
                                <ul class="news-list">
                                    <li>
