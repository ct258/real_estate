                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="width-150">
                                            <div class="progress progress-sm mt-xs js-progress-animate">
                                                <div class="progress-bar progress-bar-success" data-width="29%"
                                                    style="width: 0;"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="width-150">
                                            <div class="progress progress-sm mt-xs js-progress-animate">
                                                <div class="progress-bar progress-bar-warning" data-width="33%"
                                                    style="width: 0;"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="width-150">
                                            <div class="progress progress-sm mt-xs js-progress-animate">
                                                <div class="progress-bar progress-bar-danger" data-width="17%"
                                                    style="width: 0;"></div>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Jacob <span
                                                class="label label-warning text-gray-dark fw-semi-bold">ALERT!</span>
                                        </td>
                                        <td>Thornton</td>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge bg-gray-lighter text-gray fw-semi-bold">Pending</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            ...
                                            <td><span class="badge bg-gray-lighter text-gray-light">Unconfirmed</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            ...
                                            <td><span class="badge bg-gray-lighter text-gray fw-semi-bold">New</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>4</td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-align-center">
                                            <div class="sparkline" data-type="bar" data-bar-color="#618fb0">
                                                13,14,16,15,4,14,20</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="text-align-center">
                                            <div class="sparkline" data-type="bar" data-bar-color="#999">
                                                14,12,16,11,17,19,16</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-align-center">
                                            <div class="sparkline" data-type="bar" data-bar-color="#e5603b">
                                                13,14,20,16,15,4,14</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
