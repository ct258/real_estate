<head>
 ...
 <div class="panel-heading" style="	text-transform: capitalize;">
   Bảng thống kê khách hàng thường xuyên đăng bài
   </div>
      </div>
      <div class="col-md-6 chart_agile_left">
        <canvas id="myChart1" width="100" height="100"></canvas>
        <div class="panel-heading" style="	text-transform: capitalize;">
          Bảng thống kê khách hàng thường xuyên mua đất
          </div>
             </div>
    </div>
    <p id="name" style="opacity:0;">{{$a}}<p>
              <p id="value" style="opacity:0;">{{$b}}</p>
              <p id="c" style="opacity:0;">{{$c}}</p>
              <p id="d" style="opacity:0;">{{$d}}</p>
