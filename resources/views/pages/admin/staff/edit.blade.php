    ...
    <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    Cập nhật nhân viên
                </header> @foreach ($staff as $val)
                <div class="panel-body">
                    <form action="{{ route('staff.update', ['id'=>$val->staff_id]) }}" method="post">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  value=" {{$val->staff_code}} " readonly name="staff_code" >
                                    </div>
                                    <div class="form-group">
                                        <label>Tên nhân viên:</label>
                                        <input type="text" class="form-control" value=" {{$val->staff_name}}" name="staff_name" >
                                    </div>
                                    <div class="form-group">
                                        <label>Email:</label>
                                        <input type="email" class="form-control" value=" {{$val->staff_email}}" name="staff_email" >
                                    </div>
                                    <div class="form-group">
                                        <label >Ngày sinh:</label>
                                        <input type="text" value="{{$val->staff_birth}}"  readonly class="form-control" >
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="staff_tel" value=" {{$val->staff_tel}}" class="form-control" >
                                    </div>
                                </div>
                                <div class="col-sm-12">
