                        ...
                        <div class="container-fluid">
                            <table class="">
                                <tr>
                                    <td>
                                        <div class="col-sm-10">
                                            <img id="image" alt="Chọn hình đại diện"
                                                src="{{asset($real_estate->real_estate_avatar)}}" /><br>
                                            <input type="file" name="avatar" id="avatar"
                                                onchange="document.getElementById('image').src = window.URL.createObjectURL(this.files[0])">
                                            <br>
                                            @foreach($image as $img)
                                            <img id="photos" alt="Chọn hình sản phẩm" src="{{asset($img->image_path)}}"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" name="name_vi" size="100%" autofocus
                                            value="{{$tran_vi->translation_name}}"
                                ...
                                <tr>
                                    <td>
                                        <img src="https://lipis.github.io/flag-icon-css/flags/4x3/vn.svg"
                                            style="width:2%;" ;>
                                        <label>Địa chỉ</label>
                                        <input type="text" name="address_vi" value="{{$tran_vi->translation_address}}"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <textarea name="description_vi" cols="30" id="editor1"
                                            ...
                                            class="form-control input-transparent">{!!$tran_vi->translation_description!!}</textarea>
                                    </td>
                                </tr>
                                <br><br>
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" name="name_en" size="100%" autofocus
                                            value="{{$tran_en->translation_name}}"
                                            class="form-control input-transparent"><br></td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <img src="https://lipis.github.io/flag-icon-css/flags/4x3/gb.svg"
                                            style="width:2%;" ;>
                                        <label>Địa chỉ</label>
                                        <input type="text" name="address_en" value="{{$tran_en->translation_address}}"
                                            class="form-control input-transparent"><br>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <textarea name="description_en" cols="30" id="editor2"
                                            style="max-width:100%;height: 235px;" value=""
                                            class="form-control input-transparent">{!!$tran_en->translation_description!!}</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <div id="house">
                                ...
                                {{-- Nhà --}}
                                {{-- nếu có giá trị convenience --}}
                                <table>
                                    <tr>
                                        <td><label>Mặt tiền</label>
                                            <input type="number" name="convenience_facade" min="0" step="any"
                                                value="{{$real_estate->convenience_facade}}"
                                                class="form-control input-transparent"><br></td>
                                        <td><label>Lối vào</label>
                                            <input type="number" name="convenience_way" min="0" step="any"
                                                value="{{$real_estate->convenience_way}}"
                                                class="form-control input-transparent"><br></td>
                                        <td><label>Số tầng</label>
                                            <input type="number" name="convenience_floor" min="0" step="any"
                                                value="{{$real_estate->convenience_floor}}"
                                                class="form-control input-transparent"><br></td>
                                    </tr>
                                    <tr>
                                        <td><label>Số phòng ngủ</label>
                                            <input type="number" name="convenience_bedroom" min="0" step="any"
                                                value="{{$real_estate->convenience_bedroom}}"
                                                class="form-control input-transparent"><br></td>
                                        <td><label>Số phòng tắm</label>
                                            <input type="number" name="convenience_bathroom" min="0" step="any"
                                                value="{{$real_estate->convenience_bathroom}}"
                                                class="form-control input-transparent"><br></td>
                                        <td>
                                            <label>Phương hướng</label>
                                            <select name="direction" id="direction"
                                                class="form-control form-control-md">
                                                <option value="E" @if($real_estate->direction_code=="E") selected
                                                    @endif>@lang('E')</option>
                                                <option value="W" @if($real_estate->direction_code=="W") selected
                                                    @endif>@lang('W')</option>
                                                <option value="S" @if($real_estate->direction_code=="S") selected
                                                    @endif>@lang('S')</option>
                                                <option value="N" @if($real_estate->direction_code=="N") selected
                                                    @endif>@lang('N')</option>
                                                <option value="NE" @if($real_estate->direction_code=="NE") selected
                                                    @endif>@lang('SE')</option>
                                                <option value="SE" @if($real_estate->direction_code=="SE") selected
                                                    @endif>@lang('NE')</option>
                                                <option value="SW" @if($real_estate->direction_code=="SW") selected
                                                    @endif>@lang('SW')</option>
                                                <option value="NW" @if($real_estate->direction_code=="NW") selected
                                                    @endif>@lang('NW')</option>
                                            </select><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <div class="check">
                                                ...
                                                <input type="checkbox" name="CCTV" value=1
                                                    @if($real_estate->convenience_CCTV)
                                                @if($real_estate->convenience_CCTV) checked @endif @endif>
                                            ...
                                            <div class="check">
                                                ...
                                                <input type="checkbox" name="Concierge" value=1
                                                    @if($real_estate->convenience_concierge) checked @endif>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <select name="form" id="form" class="form-control form-control-md">
                                            ...
                                            <option value="{{$item->form_id}}" @if($item->
                                                form_id==$real_estate->form_id) selected
                                                @endif>{{$item->form_translation_name}}</option>
                                            @endforeach
                                        </select>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <select name="type" id="type" class="form-control form-control-md">
                                            <option value="{{$real_estate->type_id}}">
                                                {{$real_estate->type_translation_name}}</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <select name="unit" id="unit" class="form-control form-control-md">
                                            <option value="{{$real_estate->unit_id}}">
                                                {{$real_estate->unit_translation_name}}</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" name="acreage" value="{{$real_estate->real_estate_acreage}}"
                                            class="form-control input-transparent"><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <input type="number" name="price" min="0" step="any"
                                            value="{{floatval($real_estate->real_estate_price)}}"
                                            class="form-control input-transparent"><br>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select name="province" id="province" class="form-control form-control-md">
                                            ...
                                            <option value="{{$item->province_id}}" @if($item->
                                                province_id==$real_estate->province_id) selected
                                        ...
                                        <select name="district" id="district" class="form-control form-control-md">
                                            <option value="{{$real_estate->district_id}}">
                                                {{$real_estate->district_name}}</option>
                                        </select>

                                        <br>

                                        <select name="ward" id="ward" class="form-control form-control-md">
                                            <option value="{{$real_estate->ward_id}}">{{$real_estate->ward_name}}
                                            </option>
                                        </select>
                                        ...
                                        <select name="street" id="street" class="form-control form-control-md">
                                            @if($real_estate->street_id!=null)
                                            <option value="{{$real_estate->street_id}}">{{$real_estate->street_name}}
                                            </option>
                                            @else
